...
- [x] **SEC-01**: PII masking, AI config encryption, audit every AI request, rate limit AI endpoints, tenant isolation, input validation; Python validates `schema_name` `^school_\d+$` on every query; shared uploads volume
